...
export const CATEGORY_ICONS: Record<string, CategoryIcon> = {
  ...
  ESTUDIO: icon('<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>', "#3B82F6", "◈"),
  ...
  DEPORTE: icon('<circle cx="12" cy="12" r="8.5"/><path d="M4.5 12c3-7 12-7 15 0"/><path d="M4.5 12c3 7 12 7 15 0"/>', "#14B8A6", "●"),
  ...
  NUTRICION: icon('<path d="m5 5 2 3 2-3"/><line x1="7" y1="8" x2="7" y2="20"/><path d="M15 11 17 5 19 11 17 13"/><line x1="17" y1="5" x2="17" y2="20"/>', "#84CC16", "♦"),
